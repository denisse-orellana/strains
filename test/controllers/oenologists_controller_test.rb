...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference('Oenologist.count') do
      post oenologists_url, params: { oenologist: { age: @oenologist.age, country: @oenologist.country, editor: @oenologist.editor, name: @oenologist.name, reviewer: @oenologist.reviewer, workplace: @oenologist.workplace, writer: @oenologist.writer } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { age: @oenologist.age, country: @oenologist.country, editor: @oenologist.editor, name: @oenologist.name, reviewer: @oenologist.reviewer, workplace: @oenologist.workplace, writer: @oenologist.writer } }
